...
function sky_display_options($callback_args) {
	...
	<div id="et_custom_settings" style="margin: 13px 0 17px 4px;">	
		<div class="et_fs_setting" style="margin: 13px 0 26px 4px;">
			...
			<input type="text" style="width: 30em;" value="<?php echo esc_html($et_page_description); ?>" id="et_page_description" name="et_page_description" size="67" />
			<br />
		...
		<div class="et_fs_setting" style="margin: 13px 0 26px 4px;">
			...
			<input type="text" value="<?php echo esc_html($et_gallery_images_per_page); ?>" id="et_gallery_images_per_page" name="et_gallery_images_per_page" size="5" />
			<br />
...
add_action('save_post', 'sky_save_details');
function sky_save_details($post_id){
	global $pagenow;
...
function sky_metabox_upload_scripts( $hook_suffix ) {
	if ( 'post.php' == $hook_suffix || 'post-new.php' == $hook_suffix ) {
		wp_register_script('et_admin_delete_full_width_option', get_bloginfo('template_directory').'/js/et_admin_delete_fullwidth.js', array('jquery'));
